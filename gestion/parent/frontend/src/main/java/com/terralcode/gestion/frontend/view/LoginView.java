...
//        }
    ...
    private Component buildFields()
    {
        ...
        username.setCaption("Introduzca su email");
        username.setIcon(FontAwesome.USER);
        username.addStyleName(ValoTheme.TEXTFIELD_INLINE_ICON);
        username.focus();
//        username.addValidator(new EmailValidator("Introduzca un email correcto"));
//        username.addValidator(new NullValidator("Introduzca un email válido", false));

        final PasswordField password = new PasswordField("Contraseña");
        password.setIcon(FontAwesome.LOCK);
        password.addStyleName(ValoTheme.TEXTFIELD_INLINE_ICON);
//        password.addValidator(new StringLengthValidator("El password debe tener de 6-10 caracteres"));
//        password.addValidator(new NullValidator("El campo no puede estar vacio", false));
        ...
        signin.addClickListener(new ClickListener() {
            ...
            {
                eventBus.post(new UserLoginRequestedEvent(username
    ...
    private Component buildLabels()
    {
        ...
        Label welcome = new Label("Nombre empresa");
        welcome.setSizeUndefined();
        welcome.addStyleName(ValoTheme.LABEL_H4);
        welcome.addStyleName(ValoTheme.LABEL_COLORED);
        labels.addComponent(welcome);

        Label title = new Label("<strong>Gestión Alumnos</strong>", ContentMode.HTML);
        title.setSizeUndefined();
        title.addStyleName(ValoTheme.LABEL_H3);
        title.addStyleName(ValoTheme.LABEL_LIGHT);
//        title.setIcon(new ThemeResource("img/logo-small.jpg"));
