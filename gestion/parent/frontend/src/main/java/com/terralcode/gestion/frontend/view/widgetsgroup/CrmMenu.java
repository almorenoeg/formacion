...
//    private static final DashboardViewType CUSTOMERS = new DashboardViewType("Clientes", "customers", FontAwesome.BRIEFCASE, false);
    private static final DashboardViewType ALUMNOS = new DashboardViewType("Alumnos", "alumnos", FontAwesome.MALE, false);
    private static final DashboardViewType LISTADOS = new DashboardViewType("Listados", "ListadoAlumnos", FontAwesome.LIST, false);
